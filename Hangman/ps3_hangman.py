...
def getAvailableLetters(lettersGuessed):
    ...
    # Alternative:
    #return ''.join(sorted(set('abcdefghijklmnopqrstuvwxyz').difference(lettersGuessed)))
    #return ''.join(sorted(set('abcdefghijklmnopqrstuvwxyz') - set(lettersGuessed)))
    #return ''.join(sorted({*'abcdefghijklmnopqrstuvwxyz'} - {*lettersGuessed}))
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    lettersGuessed = []
    guesses = 8
    while not isWordGuessed(secretWord, lettersGuessed) and guesses:
        print("-----------")
        ...
        if guess in lettersGuessed:
            ...
            if guess in secretWord:
                ...
                guesses -= 1
    print("-----------")
    print("Congratulations, you won!" if guesses else
